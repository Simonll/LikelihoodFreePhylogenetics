...
class LinAlg {
 public:
  ...
  static int DiagonalizeRateMatrix(double** u, double* pi, int dim,
                                   double* eigenval, double** eigenvect,
                                   double** inveigenvect, int nmax = 1000,
  ...
  static int DiagonalizeSymmetricMatrix(double** u, int dim, int nmax,
  ...
  static double Gauss(std::vector<std::vector<double>> a, int dim,
