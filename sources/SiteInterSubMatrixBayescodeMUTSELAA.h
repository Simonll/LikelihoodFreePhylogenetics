...
*/
#ifndef SOURCES_SITEINTERSUBMATRIXBAYESCODEMUTSELAA_H_
#define SOURCES_SITEINTERSUBMATRIXBAYESCODEMUTSELAA_H_
...
class SiteInterSubMatrixBayescodeMUTSELAA : public SiteInterSubMatrix {
 public:
...
#endif  // SOURCES_SITEINTERSUBMATRIXBAYESCODEMUTSELAA_H_
