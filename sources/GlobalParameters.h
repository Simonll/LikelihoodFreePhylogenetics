...
class GlobalParameters {
 public:
  ...
  const string listCodes[NCodes] = {"Universal", "MtMam", "MtInv"};

  const string listTransformtations[NTransformations] = {"none", "log2",
                                                         "log10"};

  const string listDistances[NDistances] = {"Euclidian", "dist1", "normalized"};

  const string listParam[NParam] = {"chainID",      "root",
  ...
  const string listSummaries[NSummaries] = {"pwAC",
                                            "pwAG",
                                            "pwAT",
                                            "pwCG",
                                            "pwCT",
  ...
  const string listEvoStats[NEvoStats] = {"gtnrAA",
                                          "gtnrAC",
                                          "gtnrAG",
                                          "gtnrAT",
                                          "gtnrCA",
  ...
  const string listSiteSpecificEvoStats[NSiteSpecificEvoStats] = {"ssNsub",
                                                                  "ssNsynsub"};
