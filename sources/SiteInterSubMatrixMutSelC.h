...
*/
#ifndef SOURCES_SITEINTERSUBMATRIXMUTSELC_H_
#define SOURCES_SITEINTERSUBMATRIXMUTSELC_H_
...
class SiteInterSubMatrixMutSelC : public SiteInterSubMatrix {
 public:
...
#endif  // SOURCES_SITEINTERSUBMATRIXMUTSELC_H_
